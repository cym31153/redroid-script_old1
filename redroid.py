...
def main():
    ...
    if args.gapps:
        ...
        tags.append("gapps")
    if args.ndk:
        if args.android in ["11.0.0", "12.0.0", "12.0.0_64only", "14.0.0_64only"]:
            arch = helper.host()[0]
            ...
            helper.print_color(
                "WARNING: Libndk seems to work only on redroid:11.0.0, redroid:12.0.0, or redroid:14.0.0_64only", helper.bcolors.YELLOW)
    if args.magisk:
        Magisk().install()
